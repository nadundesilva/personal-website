        ...
        >
            ...
            >
                <div className="flex h-14 items-center px-4 sm:h-16 sm:px-6 md:px-8 lg:px-20 xl:px-40 2xl:px-80">
                    ...
                    <Link
                        ...
                        className="text-primary-foreground -mx-3 rounded-sm px-3 py-1.5 -my-1.5 text-base font-medium no-underline hover:no-underline hover:opacity-85 sm:text-xl motion-safe:transition-opacity motion-safe:duration-150 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-foreground/80"
                    >
                        {FULL_NAME}
                    </Link>
            ...
            <footer className="relative bg-background pt-8 pb-20 text-center before:absolute before:top-0 before:left-1/2 before:h-px before:w-4/5 before:-translate-x-1/2 before:bg-linear-to-r before:from-transparent before:via-muted-foreground before:to-transparent before:opacity-50 before:content-['']">
                <p className="text-muted-foreground text-sm">
                    &copy; 2021-{process.env.WEBSITE_BUILD_YEAR} {FULL_NAME}
                </p>
            </footer>
