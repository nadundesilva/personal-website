...
```yaml title="buffering-priority.yaml"
...
```yaml title="buffer-deployment.yaml"
apiVersion: apps/v1
kind: Deployment
metadata:
...
```yaml title="normal-priority.yaml"
apiVersion: scheduling.k8s.io/v1
kind: PriorityClass
metadata:
...
```yaml title="workload-deployment.yaml"
apiVersion: apps/v1
kind: Deployment
metadata:
...
```yaml title="default-priority.yaml"
apiVersion: scheduling.k8s.io/v1
kind: PriorityClass
metadata:
