export const _copyright =
     ...
     *
     * © 2019 Nadun De Silva. All rights reserved.
     */
    undefined;
...
export const metadata = {
    ...
    ...buildArticleMetadata(blogMetadata),
};
...
**Note:** If you are new to K8s and wish to get started quickly with Cellery, please use the [local setup option](https://github.com/wso2-cellery) as this is more convenient for new users.

# Setting up MicroK8s

**Note:** This article is focused on _Cellery v0.4.0_ and the requirements such as the K8s version mentioned here may change in later versions. You can check the requirements from the [Cellery SDK repository](https://github.com/wso2-cellery) if you need to use a different version.
...
To get started with Cellery, please install the CLI from the [Cellery SDK](https://github.com/wso2-cellery) repository. After the installation process finishes, the installation can be verified by running the following command.
...
Don’t forget to try out the [Samples](https://github.com/wso2-cellery) which walk you through most of the features of Cellery.
