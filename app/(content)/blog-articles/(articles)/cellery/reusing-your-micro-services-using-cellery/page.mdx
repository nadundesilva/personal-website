...
Writing a simple Cell with a single component is as simple as adding the following lines. (To view the full code along with the build, run and test life-cycle methods of this Cell and other Cells please check the [samples](https://github.com/wso2-cellery).)

```ballerina title="hello-world-api.bal"
...
<Image
    alt="Hipster Shop Microservices Mapped to Cellery Cells"
