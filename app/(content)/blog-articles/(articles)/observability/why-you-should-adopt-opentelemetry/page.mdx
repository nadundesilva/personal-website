...
[OpenTelemetry](https://opentelemetry.io/) is a CNCF project which unifies and formalizes all aspects of Observability into one specification. The specification itself was launched a few years back and it continues to evolve and gain momentum throughout the industry.
...
With the increasing adoption of OpenTelemetry in both applications and observability providers, we now have a large number of vendors supporting OpenTelemetry with most of the big players in observability and cloud out there in it. You can view the [list on the OpenTelemetry website](https://opentelemetry.io/ecosystem/vendors/) itself.
