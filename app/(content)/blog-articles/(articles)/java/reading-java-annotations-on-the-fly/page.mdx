...
```java title="RuntimeRetainedAnnotation.java"
...
Before reading this section, if you are not familiar with Repeatable Annotations you can read the repeatable annotations section in my post; [Java Custom Annotations](./java/unleashing-the-power-of-java-custom-annotations).
...
```java title="FunctionOperation.java"
@Parameter(name = "username", type = "string")
public class FunctionOperation {
    // Class Elements
}
