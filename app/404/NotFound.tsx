...
const NotFound = (): React.ReactElement => (
    <ContentContainer>
        <div className="flex flex-col items-center py-16 text-center md:py-24">
            ...
            <p
                aria-hidden="true"
                className="text-primary mb-6 text-[7rem] leading-none font-light tracking-tighter opacity-35 select-none motion-safe:animate-(--animate-not-found-float) md:text-[11rem] md:opacity-40"
            >
                404
            </p>
            ...
            <div className="mb-8 motion-safe:animate-fade-in-up motion-safe:[animation-delay:0.05s]">
                ...
                <HorizontalGradientLine
                    variant="centered"
                    className="mx-auto mt-0 w-20 md:w-36"
                />
            </div>
