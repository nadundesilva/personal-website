    ...
    return (
        <div className="relative flex min-h-lvh flex-col overflow-hidden">
            ...
            <div
                ...
                className="pointer-events-none absolute inset-0 z-2"
            >
                <div className="absolute top-[5%] left-[5%] size-87.5 rounded-full bg-(--home-aura-1-color) opacity-15 blur-[80px] motion-safe:animate-home-aura-1-drift md:size-130" />
                <div className="absolute right-[5%] bottom-[10%] size-75 rounded-full bg-(--home-aura-2-color) opacity-15 blur-[80px] motion-safe:animate-home-aura-2-drift md:size-110" />
            </div>
                ...
                <SpotlightCard className="w-[88vw] max-w-full rounded-2xl border border-white/15 bg-white/8 px-4 py-5 text-center shadow-[0_24px_80px_rgba(0,0,0,0.4)] backdrop-blur-[20px] sm:w-130 sm:px-6 sm:py-7 md:w-145 md:px-7 md:py-8 lg:w-155 lg:px-10 lg:py-12 short-h:py-3">
                    ...
                    <div className="mb-7 motion-safe:animate-fade-in-up motion-safe:[animation-delay:0.45s] md:mb-8 short-h:mb-4">
                        <Button
                            ...
                            aria-label="View CV (PDF document, opens in a new tab)"
                            className="h-auto min-w-40 rounded-full bg-(--home-cv-button-bg) px-8 py-3 text-[13px] tracking-wider text-white hover:bg-(--home-cv-button-bg-hover) motion-safe:transition-colors motion-safe:duration-250 md:min-w-48 md:px-10 md:py-2.75 md:text-[14px]"
                        >
                            View CV
                        </Button>
                    </div>
                    ...
                    <div className="mb-5 flex flex-row items-center justify-center motion-safe:animate-fade-in-up motion-safe:[animation-delay:0.55s] md:mb-6 short-h:hidden">
                    ...
                    <Separator className="mb-3 bg-white/15 motion-safe:animate-fade-in-up motion-safe:[animation-delay:0.65s] md:mb-4 short-h:mb-2" />
